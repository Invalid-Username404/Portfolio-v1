...
export const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      max-w-7xl mx-auto
       "  >
      <Link to="/" className="flex mx items-center gap-2" 
        onClick={()=> { setActive(""); window.scrollTo(0,0) } }
         >
          <img src="/assets/Logo.svg" alt="logo" className="w-9 rounded-full
            bg-cyan-700 h-9 object-contain "  />
          <p className="text-white text-[20px] font-bold cursor-pointer " >
            Moralist208</p> <span className="sm:block hidden">{'>>'} Portfolio </span> 
